...
class MultipleTypeAdapter private constructor(
    ...
    private val mHelper: AsyncListDiffer<RowContainer<*, *>> = AsyncListDiffer(CustomListUpdateCallBack(this, onChanged, onMoved, onInserted, onRemoved),
    ...
    fun <T> getDisplayObject(pos: Int): T {
        return mHelper.currentList[pos].displayObject as T
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<Any, *> {
        val strategy = viewTypeMap.getValue(viewType) as ViewStrategy<BaseViewHolder<Any, *>, ViewBinding>
        val binding = strategy.getBindingInstance(parent)
        return strategy.createVH.invoke(parent, binding)
    }
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<Any, *>, position: Int) {
        ...
        val bindView = holder.bindView as ViewBinding.(Any) -> Unit
        bindView.invoke(binding, displayObject)
    }
}